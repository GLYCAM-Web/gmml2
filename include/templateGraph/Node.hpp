#ifndef TEMPLATEGRAPH_NODE_HPP
#define TEMPLATEGRAPH_NODE_HPP

#include "include/templateGraph/Edge.hpp"
#include "include/templateGraph/GenericGraphObject.hpp"
...
namespace glygraph
{
    ...
    template<class T> inline Node<T>::~Node()
    {
        ...
        tempInEdge.clear();
        // util::log(__LINE__, __FILE__, util::INF, ("Node labelled " + this->getLabel() + " destroyed\n"));
    }
