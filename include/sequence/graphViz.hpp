#ifndef INCLUDES_CONDENSEDSEQUENCE_GRAPHVIZ_HPP
#define INCLUDES_CONDENSEDSEQUENCE_GRAPHVIZ_HPP
...
namespace gmml
{
    namespace sequence
    {
        ...
        {
            GraphVizDotConfig(
                const std::string& basePath, const std::string& directoryPath, const std::string& filename)
