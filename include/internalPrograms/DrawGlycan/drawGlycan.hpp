#ifndef INCLUDES_INTERNALPROGRAMS_DRAWGLYCAN_DRAWGLYCAN_HPP
#define INCLUDES_INTERNALPROGRAMS_DRAWGLYCAN_DRAWGLYCAN_HPP
...
{
    void drawGlycan(
        sequence::GraphVizDotConfig configs,
