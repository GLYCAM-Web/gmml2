#ifndef INCLUDE_UTIL_CONSTANTS_HPP
#define INCLUDE_UTIL_CONSTANTS_HPP
...
namespace gmml
{
    namespace constants
    {
        ...
        inline double toRadians(double d) { return (d / PI_DEGREE) * PI_RADIAN; }

        inline double toDegrees(double d) { return (d / PI_RADIAN) * PI_DEGREE; }
    } // namespace constants
} // namespace gmml
#endif
