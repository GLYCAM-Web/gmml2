...
// Oliver commenting out B-E as gems/website can't handle conformers properly yet. This is a fine stopgap to just create one shape.
          ...
          { "C2"   , "O8"     , "Omg8" ,-170.1  ,   AngleStd{20.0, 20.0}  , 0.42  , RotamerType::conformer   , "A"  , 3 , 1 , {"ulosonate", "internal"}  , {"ulosonate"}    , "O8" , "C8" , "C7" , "C6"  },
          { "C2"   , "O8"     , "Omg7" , -61.8  ,   AngleStd{20.0, 20.0}  , 0.42  , RotamerType::conformer   , "A"  , 4 , 1 , {"ulosonate", "internal"}  , {"ulosonate"}    , "C8" , "C7" , "C6" , "O6"  },
          { "C2"   , "O8"     , "Omg9" ,  65.8  ,   AngleStd{20.0, 20.0}  , 0.42  , RotamerType::conformer   , "A"  , 5 , 1 , {"ulosonate", "internal"}  , {"ulosonate"}    , "O9" , "C9" , "C8" , "O8"  },
