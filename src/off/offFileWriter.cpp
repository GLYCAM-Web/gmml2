    ...
    namespace off
    {
            ...
            const std::string& unitName)
        {
            ...
            for (size_t residueIndex : residueIndices)
            {
                ...
                { // Repeating the same atom changes the tree structure in the parm7 file. Not sure anything uses that.
                  // Old gmml code repeats so doing that.
                    // For reducing terminal old code puts a 1 2 0 0 0 0. So not repeat. Changing to 2 2 0 0 0 0 causes
                    // first atom not to be M (main). Might be an issue let's see.
