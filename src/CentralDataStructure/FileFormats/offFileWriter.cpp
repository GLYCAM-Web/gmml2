...
namespace gmml
{
        ...
        const std::string& unitName)
    {
        ...
        for (size_t residueIndex : residueIndices)
        {
            ...
            { // Repeating the same atom changes the tree structure in the parm7 file. Not sure anything uses that. Old
              // gmml code repeats so doing that.
    ...
    void WriteResiduesIndividuallyToOffFile(std::ostream& stream, const assembly::Graph& graph, const OffFileData& data)
