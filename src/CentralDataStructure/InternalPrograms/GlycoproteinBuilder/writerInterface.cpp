...
namespace glycoproteinBuilder
{
        ...
        const assembly::Graph& graph, const AssemblyData& data, const std::vector<cds::Coordinate>& atomCoordinates)
    {
        ...
        cds::OffFileResidueData residueData {
            data.residues.serializedNumbers, data.residues.names, data.residues.types, atomsConnectedToOtherResidues};
        ...
        const std::vector<std::string>& headerLines)
    {
        ...
        cds::PdbFileAtomData atomPdbData {
            atomCoordinates,
            atomNumbers,
            data.atoms.names,
