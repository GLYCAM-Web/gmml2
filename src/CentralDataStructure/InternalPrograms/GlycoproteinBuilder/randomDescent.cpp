...
namespace glycoproteinBuilder
{
        ...
        const GlycoproteinState& initialState)
    {
        ...
        {
            gmml::log(
                __LINE__, __FILE__, gmml::INF, "Cycle " + std::to_string(cycle) + "/" + std::to_string(persistCycles));
            cycle++;
            ...
            for (auto& glycanId : codeUtils::shuffleVector(rng, sitesWithOverlap))
            {
                ...
                else
                {
                    ...
                    gmml::log(
                        __LINE__, __FILE__, gmml::INF, "RandomDescent accepted a change of " + std::to_string(diff));
                }
            }
