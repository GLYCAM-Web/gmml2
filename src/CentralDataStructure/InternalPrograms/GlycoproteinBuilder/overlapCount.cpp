...
namespace glycoproteinBuilder
{
    ...
    {
        return cds::overlapsWithinSelection(
            data.potentialTable,
        ...
        size_t glycanId)
    {
        ...
        std::vector<double> overlapWithin = cds::overlapsWithinSelection(
            data.potentialTable,
            data.overlapTolerance,
            graph,
            bounds,
            ...
            data.atoms.elements,
            data.residueEdges.atomsCloseToEdge);
        std::vector<double> overlapBetween = cds::overlapsBetweenSelections(
            data.potentialTable,
            data.overlapTolerance,
            graph,
            bounds,
