...
namespace glycoproteinBuilder
{
    ...
    {
        const std::vector<size_t>& glycanLinkages = graphs.indices.glycans[glycanId].linkages;
        ...
        {
            const ResidueLinkageIndices& linkage = graphs.indices.residueLinkages[glycanLinkages[n]];
